...
export const PRODUCT_HERO_LEDE =
  'Name the task you keep delaying. Pick something you enjoy—games, music, coding, sports, anything. Bridge splits the job bite-size; you save after each bit, then get the next. Keep going until the work is really finished.';

export const PRODUCT_EXAMPLE_CALLOUT_TITLE = 'Example: a school paper, with steps like coding';

export const PRODUCT_EXAMPLE_CALLOUT_BODY =
  'The end result is still a paper. The steps just feel like coding: make a simple plan, build one part, try a rough version, fix it up. After each step you save, Bridge checks in and tells you what to do next—until the paper is done.';

export const PRODUCT_QUICK_START_LABEL =
