...
/** Must match `bridge_core.completion_engine.SUPPORTED_FRAMES` and `onboardingOptions` chips. */
...
/** Maps onboarding / legacy pathway ids to `completion_engine.SUPPORTED_FRAMES` keys. */
